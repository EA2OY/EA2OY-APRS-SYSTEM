...
> Comprobado el 2026-09-14 con un T-Echo Plus real (el de EA2XXX, con S140 **7.2.0**): el binario de
...
El T-Echo de EA2XXX llevaba el **cargador de arranque 0.6.1 (octubre de 2021)**, no el 0.10.0 del
...
**Comprobado el 2026-09-14 con el T-Echo de EA2XXX** (que llevaba el firmware de cfr34k, DL5TKL):
...
- La **configuración** de ese firmware (donde va el indicativo) **no vive ahí**: el firmware del
  ...
  que copia el `.uf2`.
- Por eso **la palabra `EA2XXX` no aparece ni una vez** en el respaldo (comprobado buscándola). Lo que
