...
> **★ CONFIRMADO POR LA PEGATINA DE LA PROPIA PLACA (2026-09-15)**: la unidad de **EA2ABC**
...
> Con el comando `i2cscan` (por USB, `sensorsI2cScan()`), en la unidad **T-Echo Plus de EA2XXX**:
>
> ```
...
> comprobará con **el mismo comando** en la unidad de EA2ABC. Mientras tanto, **manda lo que
> dice la placa** (regla 0): en la unidad de EA2XXX, el firmware no puede publicar meteorología
