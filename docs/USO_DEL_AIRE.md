...
En esas 21 horas el nodo ha oído **48 tramas, todas de N0CALL-10** (unas 2,3 por
...
rosca, al que desconectan es a N0CALL-10, no al nodo. Nuestro nodo no habla con
Internet.

**Capa de atribución (la "anotación"):** ahí sí es todo del indicativo. Cada
paquete viaja como `EA2OY-7>APLRG1,TCPIP*,qAR,N0CALL-10:...`, así que quedan los
