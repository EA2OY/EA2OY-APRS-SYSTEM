...
| 🧠 [`context/`](context) | La memoria del proyecto (reglas, estado real e histórico), por si lo retoma un agente |
...
- 🧠 [`context/`](context) — project memory for AI agents: rules, real state, history
