...
void displayNextScene(bool porToque) { (void)porToque; }
void displayPopup(const char *text) { (void)text; }

// Gancho del boton para las esperas de la pantalla: aqui no hay pantalla que espere.
void displaySetPumpBoton(void (*fn)(void)) { (void)fn; }
